...
[Download Appendix D PDF](pdfs/appendix-d.pdf){target="_blank" .btn .btn-outline-primary} &nbsp;&nbsp; The complete PDF is embedded below and available for download.
:::

```{=html}
<iframe src="pdfs/appendix-d.pdf" width="100%" height="950px" style="border: 1px solid #dee2e6; border-radius: 4px;"></iframe>
```
